...
** TODO** THIS DOESN'T FROM THE PREVIOUS ONE.  BUT WITH THE ADDITIONAL STEPS MAKE IT CLEAR>
...
To see these changes are on the server 
...
To edit a PR, push changes to the fork you cloned to your desktop
...
** TODO** As discussed, put in a few steps to make it clear this is on your own repo in github desktop, but it shows up as an additional commit in the PR on the other one.
