...
.. code-block:: julia
  ...
  f0 = pdf.(Beta(1, 1), linspace(0, 1))
  f0 = f0 / sum(f0)
  f1 = pdf.(Beta(9, 9), linspace(0, 1))
...
.. literalinclude:: /_static/code/wald_friedman/wf_first_pass.jl
...
.. literalinclude:: /_static/code/wald_friedman/wald_class.jl
...
.. code-block:: julia
  ...
  function analysis_plot(;c=1.25, L0=27.0, L1=27.0, a0=2.5, b0=2.0, a1=2.0, b1=2.5, m=251)
      f0 = pdf.(Beta(a0, b0), linspace(0, 1, m))
      f0 = f0 / sum(f0)
      f1 = pdf.(Beta(a1, b1), linspace(0, 1, m))
      f1 = f1 / sum(f1)  # Make sure sums to 1
