...
The code can be found in the file `arellano_vfi.jl <https://github.com/QuantEcon/QuantEcon.lectures.code/blob/master/arellano/arellano_vfi.jl>`__ but we repeat it here for convenience

(Results and discussion follow the code)

.. literalinclude:: /_static/code/arellano/arellano_vfi.jl
