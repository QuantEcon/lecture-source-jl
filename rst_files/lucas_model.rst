...
`lucastree.jl <https://github.com/QuantEcon/QuantEcon.lectures.code/blob/master/lucas_model/lucastree.jl>`__

We repeat it here for convenience

.. literalinclude:: /_static/code/lucas_model/lucastree.jl
